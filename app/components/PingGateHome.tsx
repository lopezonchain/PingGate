    ...
    <div className="bg-[#0f0d14] text-white flex flex-col h-full">
      ...
      <header className="flex flex-col items-center pb-1 px-1 flex-shrink-0">
        <div className="flex items-center space-x-3">
         ...
         <p className="text-gray-300 text-[12px] text-center leading-snug italic tracking-wide py-2">
      ...
      <div className="flex-grow flex flex-col overflow-hidden">
        ...
        <section className="relative w-full flex-grow overflow-hidden">
          ...
          <motion.button
            ...
            aria-label="Previous"
            className="absolute left-4 bottom-[1px] p-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-full transition z-20"
            initial={{ y: "-50%" }}
          ...
          <motion.button
            onClick={() => changeSlide(1)}
            aria-label="Next"
            className="absolute right-4 bottom-[1px] p-3 bg-white bg-opacity-20 backdrop-blur-sm rounded-full transition z-20"
            initial={{ y: "-50%" }}
            whileHover={{ y: "-50%", scale: 1.2, rotate: 10 }}
          >
